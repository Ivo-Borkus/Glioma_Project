...
object_name <- "Harmony"
reduction_name <- "TAMs_Harmony"
Processed_name <- "TAMs_Harmony"
...
subsetting <- c("Ann_lvl_1", c("Microglia", "Macrophage", "Myeloid_Prolif")) #  Subset-col, cells_of_interest
...
harmony <- TRUE # Run harmony or not
...
.tabsetter(plot_list_score, overall_name = paste0("Scoring plots: ", reduction_name), path = rmd_path)
```
